...
export function useMoveSizes(
  options?: Omit<UseQueryOptions<MoveSize[], Error>, "queryKey" | "queryFn">
) {
  return useQuery({
...
export function useUpdateMoveSize(
...
export function useCreateMoveSize(
  mutationOptions?: Omit<
    UseMutationOptions<
      MoveSize,
      Error,
      Partial<MoveSize> & { image?: File | null }
    >,
    "mutationFn" | "mutationKey"
  >
) {
...
export function useDeleteMoveSize(
  mutationOptions?: Omit<
