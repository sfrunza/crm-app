import {
  ...
  getEntranceTypes,
  updateEntranceType,
} from "@/api/endpoints/entrance-types"
...
export function useEntranceTypes(
  options?: Omit<UseQueryOptions<EntranceType[], Error>, "queryKey" | "queryFn">
) {
  return useQuery({
...
export function useUpdateEntranceType(
  mutationOptions?: Omit<
    UseMutationOptions<
      EntranceType,
      Error,
      { id: number; data: Partial<EntranceType> }
    >,
...
export function useCreateEntranceType(
  mutationOptions?: Omit<
...
export function useDeleteEntranceType(
  mutationOptions?: Omit<
