import {
  ...
  getPackingTypes,
  updatePackingType,
} from "@/api/endpoints/packing-types"
...
export function usePackingTypes(
  options?: Omit<UseQueryOptions<PackingType[], Error>, "queryKey" | "queryFn">
) {
  return useQuery({
...
export function useUpdatePackingType(
  mutationOptions?: Omit<
    UseMutationOptions<
      PackingType,
      Error,
      { id: number; data: Partial<PackingType> }
    >,
...
export function useCreatePackingType(
  mutationOptions?: Omit<
...
export function useDeletePackingType(
  mutationOptions?: Omit<
