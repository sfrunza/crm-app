...
/** Row shape from GET /api/v1/payments (PaymentIndexSerializer) */
...
export type PaymentListResponse = {
  ...
  /** Sum of `amount` (cents) for all payments matching current filters (not paginated). */
  total_amount: number
}
...
/** GET /payments/status_counts — keys match Payment enum + all */
...
export type PaymentStatusCountsParams = {
  start_date?: string
  end_date?: string
}
