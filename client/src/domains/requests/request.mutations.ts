  ...
  return useMutation({
    mutationFn: async ({ id, data }) => {
      ...
      const shouldCalculate =
        forceCalculate || updatedRequest.is_calculator_enabled
...
export function usePairRequests(
  mutationOptions?: Omit<
    UseMutationOptions<
      Request,
      Error,
      { requestId: number; pairedRequestId: number }
    >,
    "mutationFn"
  >
) {
  return useMutation({
    mutationFn: ({ requestId, pairedRequestId }) =>
      pairRequests(requestId, pairedRequestId),
    ...mutationOptions,
  })
}
...
export function useUnpairRequests(
  ...
  return useMutation({
    mutationFn: ({ requestId, pairedRequestId }) =>
      unpairRequests(requestId, pairedRequestId),
    ...mutationOptions,
  })
}
...
export function useAttachSignature(
  mutationOptions?: Omit<
    UseMutationOptions<
      Request,
      Error,
      { requestId: number; signatureDataUrl: string }
    >,
    "mutationFn"
  >
) {
  return useMutation({
    mutationFn: ({ requestId, signatureDataUrl }) =>
      attachSignature(requestId, signatureDataUrl),
    ...mutationOptions,
  })
}
