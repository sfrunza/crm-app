...
export function useCreateMoveSizeRoom(
  options?: Omit<
    UseMutationOptions<
      MoveSizeRoom,
      Error,
      { moveSizeId: number; data: CreateMoveSizeRoomPayload }
    >,
    "mutationFn"
  >
) {
...
export function useUpdateMoveSizeRoom(
  options?: Omit<
    UseMutationOptions<
      MoveSizeRoom,
      Error,
      { moveSizeId: number; id: number; data: UpdateMoveSizeRoomPayload }
    >,
    "mutationFn"
  >
) {
  return useMutation({
    mutationFn: ({ moveSizeId, id, data }) =>
      updateMoveSizeRoom(moveSizeId, id, data),
    ...options,
  })
}
...
export function useDeleteMoveSizeRoom(
  options?: Omit<
    UseMutationOptions<void, Error, { moveSizeId: number; id: number }>,
    "mutationFn"
  >
) {
  return useMutation({
